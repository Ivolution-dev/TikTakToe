...
# 101 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\libcxx\\stdio.h" 3
...
# 102 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\libcxx\\stdio.h" 2 3
...
# 1 "./../../../Src/Board/STM32F769-Discovery\\ReportHandler.h" 1
# 11 "./../../../Src/Board/STM32F769-Discovery\\ReportHandler.h"
...
# 22 "../../../Src/main.cpp" 2
# 1 "./../../../Src/Board/STM32F769-Discovery\\config.h" 1
# 35 "./../../../Src/Board/STM32F769-Discovery\\config.h"
# 1 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.cpp" 1
# 12 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.cpp"
# 1 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.h" 1
# 19 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.h"
namespace EmbSysLib {
namespace Hw {
# 30 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.h"
...
# 181 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.h"
...
# 224 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.h"
...
# 13 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.cpp" 2


namespace EmbSysLib {
namespace Hw {
# 39 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Display/DisplayGraphic_OTM8009A.cpp"
void DisplayGraphic_OTM8009A::init( )
{
  ...
  { const BYTE data[] = {CMD_CASET, 0x00, 0x00, (BYTE)((Hsize-1)>>8), (BYTE)((Hsize-1)&0xFF)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
  { const BYTE data[] = {CMD_PASET, 0x00, 0x00, (BYTE)((Vsize-1)>>8), (BYTE)((Vsize-1)&0xFF)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
...
void DisplayGraphic_OTM8009Acmd::setPixel( WORD color,
                                           ...
                                           WORD y )
{
  { const BYTE data[] = {CMD_CASET, (BYTE)(x>>8), (BYTE)(x&0xFF), (BYTE)(x>>8), (BYTE)(x&0xFF)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
  { const BYTE data[] = {CMD_PASET, (BYTE)(y>>8), (BYTE)(y&0xFF), (BYTE)(y>>8), (BYTE)(y&0xFF)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };

  { const BYTE data[] = {CMD_RAMWR, (BYTE)(color>>8), (BYTE)(color>>3), (BYTE)(color<<3)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
}
...
void DisplayGraphic_OTM8009Acmd::setPixel( WORD color )
{
  ...
  if( flag == 1 )
  {
    { const BYTE data[] = {CMD_CASET, (BYTE)(x>>8), (BYTE)(x&0xFF), (BYTE)((x+aw-1)>>8), (BYTE)((x+aw-1)&0xFF)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
    { const BYTE data[] = {CMD_PASET, (BYTE)(y>>8), (BYTE)(y&0xFF), (BYTE)((y+ah-1)>>8), (BYTE)((y+ah-1)&0xFF)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
  ...
  {
    { const BYTE data[] = {CMD_RAMWRCNT, (BYTE)(color>>8), (BYTE)(color>>3), (BYTE)(color<<3)}; hwDSI.writeLong( (BYTE*)data, sizeof(data) ); };
  }
...
: DisplayGraphic_OTM8009A( hwDSI, resetPin, orientation, font, zoom )
{
  ...
  ptrStart = (volatile uint16_t *)this->hwDSI.startLTDC( Hsize, Vsize );
  ptr = ptrStart;
...
# 36 "./../../../Src/Board/STM32F769-Discovery\\config.h" 2
# 1 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.cpp" 1
# 11 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.cpp"
# 1 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.h" 1
# 18 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.h"
namespace EmbSysLib {
namespace Hw {
# 29 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.h"
class Touch_FT6206 : public Touch
{
  ...
  public:
# 51 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.h"
...
# 12 "C:/EmbSysLib-01.04.00/Src\\Hardware/Peripheral/Touch/Touch_FT6206.cpp" 2
...
# 37 "./../../../Src/Board/STM32F769-Discovery\\config.h" 2


# 1 "./../../../Src/Board/STM32F769-Discovery/../../Resource/Color/Color.h" 1
# 30 "./../../../Src/Board/STM32F769-Discovery/../../Resource/Color/Color.h"
class Color
{
  public:
# 44 "./../../../Src/Board/STM32F769-Discovery/../../Resource/Color/Color.h"
    typedef enum
    {

      Black = ( (((0 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),
      DarkGrey = ( (((64 )& 0xF8) >> 3) |(((64)& 0xFC) << 3) |(((64 )& 0xF8) << 8)),
      Grey = ( (((128 )& 0xF8) >> 3) |(((128)& 0xFC) << 3) |(((128 )& 0xF8) << 8)),
      LightGrey = ( (((192 )& 0xF8) >> 3) |(((192)& 0xFC) << 3) |(((192 )& 0xF8) << 8)),
      White = ( (((255 )& 0xF8) >> 3) |(((255)& 0xFC) << 3) |(((255 )& 0xF8) << 8)),

      Red = ( (((0 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((255 )& 0xF8) << 8)),
      Green = ( (((0 )& 0xF8) >> 3) |(((255)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),
      Blue = ( (((255 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),

      Yellow = ( (((0 )& 0xF8) >> 3) |(((255)& 0xFC) << 3) |(((255 )& 0xF8) << 8)),
      Cyan = ( (((255 )& 0xF8) >> 3) |(((255)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),
      Magenta = ( (((255 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((255 )& 0xF8) << 8)),


      DarkRed = ( (((0 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((128 )& 0xF8) << 8)),
      DarkGreen = ( (((0 )& 0xF8) >> 3) |(((128)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),
      DarkBlue = ( (((128 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),

      DarkYellow = ( (((0 )& 0xF8) >> 3) |(((128)& 0xFC) << 3) |(((128 )& 0xF8) << 8)),
      DarkCyan = ( (((128 )& 0xF8) >> 3) |(((128)& 0xFC) << 3) |(((0 )& 0xF8) << 8)),
      DarkMagenta = ( (((128 )& 0xF8) >> 3) |(((0)& 0xFC) << 3) |(((128 )& 0xF8) << 8))
...
# 40 "./../../../Src/Board/STM32F769-Discovery\\config.h" 2
...
Timer_Mcu timer( Timer_Mcu::TIM_11, 100L );
...
I2Cmaster_Mcu i2cBusTouch( I2Cmaster_Mcu::I2C_4, 400 );
...
# 189 "./../../../Src/Board/STM32F769-Discovery\\config.h"
...
Digital led_A( portJ,13, Digital::Out, 0 );
Digital btn_A( portA, 0, Digital::In, 0 );
...
int main( void )
{
  ...
  while( 1 )
  {
    ...
    if( cnt%(screenGraphic.getWidth() - bitmapBitmap_32x32.getWidth() ) == 0 )
    {
      ...
      screenGraphic.drawText( 10, 25, "Apr 22 2024" "," "12:10:43" );
